...
<body>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/shorts.jpg" alt="" width="100%"  id="ProductImg">
                    
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/shorts-1.jpg" width="100%" class="Small-Img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/shorts-2.jpg" width="100%" class="Small-Img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/shorts.jpg" width="100%" class="Small-Img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/shorts-3.jpg" width="100%" class="Small-Img">
                        </div>
                    </div>
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-4">
                <img src="images/smart watch.webp" alt="">
                <h4>Block Show</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>

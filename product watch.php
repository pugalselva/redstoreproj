...
<body>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/watch.jpg" alt="" width="100%"  id="ProductImg">
                    
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/watch-1.jpg" width="100%" class="Small-Img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/watch-2.jpg" width="100%" class="Small-Img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/watch-3.jpg" width="100%" class="Small-Img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/watch-4.jpg" width="100%" class="Small-Img">
                        </div>
                    </div>
